...
export class MinHeap<T>{
  ...
  private getSmallerChildIndex(leftChildIndex: number, rightChildIndex: number): number {
  ...
  public popTop(): T {
    ...
    //the furst actual value will be the smallest element in the min heap
    ...
    if (leftChildIndex > size && rightChildIndex > size) {
      ...
      smallerChildIndex = this.getSmallerChildIndex(leftChildIndex, rightChildIndex);
    }
